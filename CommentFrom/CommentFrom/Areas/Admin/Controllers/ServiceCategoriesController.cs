...
namespace CommentFrom.Areas.Admin.Controllers
{
    ...
    public class ServiceCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Id")] ServiceCategory serviceCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Id")] ServiceCategory serviceCategory)
        {
